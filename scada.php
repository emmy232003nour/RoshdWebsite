    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>SCADA and DATA Monitoring systems</h2>
          <ol>
            
            <li>Services</li>
            <li>SCADA and DATA Monitoring systems</li>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            <img src="assets/img/portfolio/scada.jpg" class="img-fluid" alt="SCADA and DATA Monitoring systems">
            <img src="assets/img/portfolio/scada1.jpg" class="img-fluid" alt="SCADA and DATA Monitoring systems">
            <img src="assets/img/portfolio/scada2.jpg" class="img-fluid" alt="SCADA and DATA Monitoring systems">
          </div>
        ...
        <div class="portfolio-description">
          ...
          <p>
          Supervisory Control And Data Acquisition (SCADA) is provided by ROSHD Organization of Technology, SCADA systems comprising computers, networked data communications, Video Wall for graphical user interfaces (GUI) forhigh-level process supervisory management for sectors of industrial, commercial, residential and infrastructure including factories, tunnels, airports commercial mall sand buildings etc. for data monitoring, analysis, control and management based on technology of internet of things IoT and industry4. 0 up to the next industry revolution generations.
          </p>
        </div>
      </div>
