      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            <img src="assets/img/portfolio/cs.jpg" class="img-fluid" alt="Cyber Security">
            <img src="assets/img/portfolio/cs1.jpg" class="img-fluid" alt="Cyber Security">
            <img src="assets/img/portfolio/cs2.jpg" class="img-fluid" alt="Cyber Security">
          </div>
...
<ul>
<li>
ROSHD Organization of Technologyprovide IT –OT cyber Security services and techniques:
<li>
Develop unique, effective security strategies for systems, networks, data centers, and Cloud.</li>
<li>
Implement/build-in security systems to software, hardware, and components.</li>
<li>
recommend the best ways to secure company-wide IT/OT infrastructure.</li>
<li>
Build firewalls to protect network infrastructures.</li>
<li>
Monitor software for external intrusions, attacks, and hacks.</li>
<li>
Close off security vulnerabilities & risks.</li>
<li>
Identify cyber attackers.</li>
          </p>
        </div>
      </div>
