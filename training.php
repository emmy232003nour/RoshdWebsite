      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            <img src="assets/img/portfolio/t.jpg" class="img-fluid" alt="Training Academy">
            <img src="assets/img/portfolio/t1.jpg" class="img-fluid" alt="Training Academy">
            <img src="assets/img/portfolio/t2.jpg" class="img-fluid" alt="Training Academy">
          </div>
...
ROSHD Training Academy is providing a professional training materials :
<li>
PLC, HMI </li>
<li>
SCADA and Data Monitoring systems</li>
<li>
OT / IT Cyber Security fundamentals</li>
<li>
Networks and Information System administration</li>
<li>
CMMS: Computerized Maintenance Management Systems</li>
<li>
Customized training programs</li>
          </p>
        </div>
      </div>
